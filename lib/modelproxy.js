...
ModelProxy.prototype = {
        ...
        this._sendRequestsParallel( this._queue, f, ef || this._errCallback );
 ...
 */
ModelProxy.init = function( path, callback ) {
    if ( typeof path === 'string' ) {
        ...
        ProxyFactory.use( new InterfaceManager( path, globalConf ) );
    }
