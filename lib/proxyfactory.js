...
ProxyFactory.setStatus = function( status ) {
 ...
 * @throws errors
 */
ProxyFactory.use = function( ifmgr ) {
...
ProxyFactory.getMockEngine = function() {
    if ( this._mockEngine ) {
...
ProxyFactory.getInterfaceIdsByPrefix = function( pattern ) {
    return interfaceManager.getInterfaceIdsByPrefix( pattern );
};

// @throws errors
ProxyFactory.getRule = function( interfaceId ) {
...
// Proxy factory
// @throws errors
ProxyFactory.create = function( interfaceId ) {
    ...
    return this.objects[ interfaceId ] = new Proxy( opt );
};
