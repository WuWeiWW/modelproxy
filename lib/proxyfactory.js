...
ProxyFactory.Interceptor = function( req, res ) {
    ...
    // params.__cookie__ = req.headers.cookie;
    try {
    ...
    // proxy.request( params, function( data, cookie ) {
    //     console.log( data );
    //     // res.setHeader( 'Set-Cookie', ['zyz=abc','cookie2=1234567','zzz=zzz'] );
