...
var mtopCofig = {
    urls: {
        prod: 'http://api.waptest.taobao.com/rest/h5ApiUpdate.do',
...
MtopProxy.prototype.interceptRequest = function( req, res ) {
    var params = {
        data: querystring.parse( req.url.replace( /^[^\?]*\?/, '' ) ),
        api: this._opt.api,
        v: this._opt.v,
        appKey: this._opt.appKey,
        t: new Date().getTime()
    ...
    MtopProxy.super_.prototype.interceptRequest.call( this, req, res );
};
